...
class AccountViewContainer extends Component {
	...
	updateUser() {
		let form = Object.assign({}, this.state.userDetailFormFields);
		form['id'] = this.props.currentUser.id;
		this.props.dispatch(userAction.updateUser(form));
	}

	updatePassword() {
		let form = Object.assign({}, this.state.passwordUpdateFormFields);
		form['id'] = this.props.currentUser.id;
			...
			<Grid stackable style={{marginTop: '20px'}}>
				<Grid.Row centered columns={2}>
					<Grid.Column textAlign='left' mobile={16} tablet={10} computer={7}>
						<UserDetailForm changeFormField={this.changeUserDetailFormField.bind(this)}
					...
					<Grid.Column textAlign='left' mobile={16} tablet={10} computer={7}>
						<PasswordUpdateForm changeFormField={this.changePasswordUpdateFormField.bind(this)}
