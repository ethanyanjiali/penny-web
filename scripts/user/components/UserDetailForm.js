...
import { Card, Icon, Form, Button, Input, Dropdown, Message } from 'semantic-ui-react';
...
class UserDetailForm extends Component {
  	...
  	render() {
  		const { email, first_name, last_name, favourite } = this.props.fields;
				...
				<Card.Content>
					<Form loading={this.props.isLoading}
						...
						<Form.Field>
							...
							<Dropdown placeholder='What do you like... '
								name='favourite'
								value={favourite || ""}
								fluid search selection options={cuisineOptions}
								onChange={(event, value) => { this.props.changeFormField(value); }}/>
						</Form.Field>
					</Form>
				</Card.Content>
