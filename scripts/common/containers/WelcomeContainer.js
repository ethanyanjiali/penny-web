...
import {
  Grid, Image, Button, Icon, Header, Divider, List,
...
style={{
      top: '50%', marginTop: '-100px', textAlign: 'center', position: 'absolute', width: '100%',
    }}
              >
        ...
        <span style={{ color: 'grey' }}>{ formatMessage(messages.welcome.buttons.history) }</span>
      </Link>
                </div>
              </div>
            )}
          ...
          <Media
            ...
            render={() => (
              <div
                className="welcome-section"
style={{
      top: '50%', marginTop: '-150px', textAlign: 'center', position: 'absolute', width: '100%',
    }}
              >
        ...
        <div style={{
          padding: '12%', paddingTop: '10%', background: '#fdfdfd', borderBottom: '1px solid #eee',
        }}
        >
          <Media
            ...
            render={() => (
              <div style={{ textAlign: 'center' }}>
                ...
                <Image
                  style={{
        margin: 'auto', marginBottom: '30px', marginTop: '30px', display: 'block',
      }}
                  src={require('../../../assets/images/tutorial_1.png')}
                  size="small"
                  label={{
        as: 'a', color: 'blue', content: 'Step 1', ribbon: true,
      }}
                />
        ...
        margin: 'auto', marginBottom: '30px', marginTop: '30px', display: 'block',
                  ...
                  size="small"
                  label={{
        as: 'a', color: 'blue', content: 'Step 2', ribbon: true,
      }}
                />
        ...
        margin: 'auto', marginBottom: '30px', marginTop: '30px', display: 'block',
                  ...
                  size="small"
                  label={{
        as: 'a', color: 'blue', content: 'Step 3', ribbon: true,
      }}
                />
          ...
          <Media
            ...
            render={() => (
              <div style={{ textAlign: 'center' }}>
                ...
                <Image
                  style={{
        margin: 'auto', marginBottom: '50px', marginTop: '50px', display: 'block',
      }}
                  src={require('../../../assets/images/tutorial_1.png')}
                  size="medium"
                  label={{
        as: 'a', color: 'blue', content: 'Step 1', ribbon: true, size: 'large',
      }}
                />
        ...
        margin: 'auto', marginBottom: '50px', marginTop: '50px', display: 'block',
                  ...
                  size="medium"
                  label={{
        as: 'a', color: 'blue', content: 'Step 2', ribbon: true, size: 'large',
      }}
                />
        ...
        margin: 'auto', marginBottom: '50px', marginTop: '50px', display: 'block',
                  ...
                  size="medium"
                  label={{
        as: 'a', color: 'blue', content: 'Step 3', ribbon: true, size: 'large',
      }}
                />
